...
- **S-25: every surface that renders sprint data names the sprint and shows its dates — the wizard's cadence step, Dashboard "Today", and Sprint Detail — prominently enough to answer "which sprint is this?" without hunting.** — Archived 2026-08-30 → `context/archive/2026-08-30-sprint-identity-visibility/`. Lesson: —.
