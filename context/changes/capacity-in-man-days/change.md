...
survive a `/clear` without landing on S-13). No roadmap ID assigned yet; the
closest existing entries are **S-18** `next-sprint-capacity` and **S-08**
`absence-calendar`, both of which this touches.
