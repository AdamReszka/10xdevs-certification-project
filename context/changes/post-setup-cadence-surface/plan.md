...
- [x] 3.1 Linting passes: `npm run lint` — 3c1be19
- [x] 3.2 Type checking passes: `npm run typecheck` — 3c1be19
- [x] 3.3 Unit tests pass: `npm test` — 3c1be19
- [x] 3.4 Integration tests pass: `npm run test:integration` — 3c1be19
- [x] 3.5 Restore on an overridden account refreshes the cadence columns and clears the flag — 3c1be19
- [x] 3.6 A restore whose Jira call fails leaves the cadence AND the flag untouched — 3c1be19
- [x] 3.7 `importCadence` without `forceCadenceRefresh` still preserves an override — 3c1be19
- [x] 3.8 `restoreCadenceAction` refuses with `demo_mode` while the workspace is demo — 3c1be19
