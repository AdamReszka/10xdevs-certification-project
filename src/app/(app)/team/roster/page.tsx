...
/**
 * The roster at `/team/roster` (S-15) — the post-setup roster surface, and the
 * half of FR-006 that S-04 left unbuilt. It lived at `/settings/team` until
 * S-19 moved it into the Team section; `/settings/team` still redirects here.
 *
