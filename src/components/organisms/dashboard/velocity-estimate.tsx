...
import { MIN_SAMPLE_SIZE, type VelocityEstimateView } from "@/lib/measurement/estimate";
...
function emptyCopy(view: VelocityEstimateView, sprintLabel: string): string {
  ...
  switch (view.reason) {
    ...
    case "no-capacity":
      return `SprintFlow has ${view.usableSprints} usable closed ${plural(view.usableSprints, "sprint")}, but no capacity figure for ${sprintLabel} to scale them by.`;
    default:
