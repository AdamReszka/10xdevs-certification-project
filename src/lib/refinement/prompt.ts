...
const SYSTEM_PROMPT = [
  ...
  "",
  "WRITE EVERY `groundingClause` AND EVERY `question` IN POLISH. The team writes its tickets in Polish,",
  "your sentence quotes that ticket's own content back, and the lead carries your question to the ticket's",
  "Polish-speaking author. `taskKind`, `verdict` and `gapClass` stay exactly as the vocabularies spell them —",
  "they are identifiers, not prose. Quote the ticket's own words verbatim rather than translating them.",
  "",
